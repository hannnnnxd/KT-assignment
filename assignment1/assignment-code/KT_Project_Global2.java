 ...
 */
public class KT_Project_Global2 {
    public static void main(String [] args){
        ...
        String resultFile = "/Users/hannnnn/Desktop/knowledge_technologies/Assignment/kt_data/result_Global2.txt";
        int total = 0;
        int match_num = 0;
        int match_num_ = 0;
        int total_ = 0;
    ...
    public static int match_pr(String model, String test){
        ...
        m = model.toCharArray();
        t = test.toCharArray();
        //r parameter is [m, d, i, r]=[1,-1,-1,(-1,0,1)]
        int insertion = -1;
        int deletion = -1;
        int replace = -1;
        int new_replace = 0;
        int new_new_replace = 1;
        int equal = 2;
                        ...
                        switch (m[j-1]){
                            ...
                            case 'y':
                                if(t[i-1] == m[j-1]) {
                                    ...
                                    arry[i][j]=Math.max(Math.max(arry[i-1][j]+insertion, arry[i][j-1]+deletion),arry[i-1][j-1]+new_new_replace);
                                }
                                break;
                            default:
                                if(t[i-1] == m[j-1]){
