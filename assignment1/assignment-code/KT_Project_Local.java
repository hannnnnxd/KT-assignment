...
public class KT_Project_Local {
    public static void main(String [] args){
        ...
        String resultFile = "/Users/hannnnn/Desktop/knowledge_technologies/Assignment/kt_data/result_Local.txt";
        int total = 0;
        int match_num = 0;
        int total_ = 0;
    ...
    public static int match(String model, String test){
